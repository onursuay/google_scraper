...
(function () {
    var DICT = {
        en: {
            ...
            'gs-pick-btn':       'Pick File from Drive',
            'gs-change-btn':     'Change',
            'gs-picker-err':     'Could not open Picker. Please try again.',
            'gs-tab-err':        'Could not load sheets',
